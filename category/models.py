...
class WorkModel(models.Model):
    ...
    graphCategory = models.DecimalField(max_digits=10, decimal_places=2)
    value = models.DecimalField(max_digits=10, decimal_places=2)
    color = models.CharField(max_length=100, blank=True)
    year = models.DecimalField(max_digits=10, decimal_places=2)
    district = models.DecimalField(max_digits=10, decimal_places=2)
    state = models.DecimalField(max_digits=10, decimal_places=2)
